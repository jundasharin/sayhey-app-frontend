<template>
  <div class="register-card">
    ...
    <b-form @submit.prevent="postRegister">
      ...
      >
      <span class="line">
        <h2><span>Register with</span></h2></span
      >
      <b-button class="google-button" variant="info"
        ><b-icon icon="google" class="mr-1"></b-icon>Google</b-button
      >
    </b-form>
    <p class="sign-in-text">
      Have an account?<button
        @click="goToLogin"
        style="border:none; background-color:transparent; box-shadow: none !important;"
      >
        Sign in
      </button>
    </p>
